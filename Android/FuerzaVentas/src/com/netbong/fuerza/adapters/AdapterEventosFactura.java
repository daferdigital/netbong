...
public class AdapterEventosFactura extends BaseAdapter
{

    public AdapterEventosFactura(Context context1, CursorEventosFactura cursoreventosfactura)
    {
        context = context1;
        crEventos = cursoreventosfactura;
    }
    ...
    private CursorEventosFactura crEventos;
}
