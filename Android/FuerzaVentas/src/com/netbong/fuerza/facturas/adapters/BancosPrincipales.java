...
public class BancosPrincipales extends BaseAdapter
{

    public BancosPrincipales(Context context1, CsrBancos csrbancos, android.view.View.OnClickListener onclicklistener)
    {
        context = context1;
        crBancos = csrbancos;
        ocl = onclicklistener;
